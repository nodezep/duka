...
export const GUIDE_STEPS: GuideStep[] = [
  {
    ...
    defaultTitle: "1. Open Shop & Branches",
    descKey: "guide.step1.desc",
    defaultDesc: "Configure your store branches, business profile, and tax settings.",
    icon: Store,
    route: "/branches",
    actionHintKey: "guide.step1.hint",
    defaultActionHint: "Go to Branches to manage physical locations and cashiers.",
    details: [
      "Navigate to 'Branches' from the sidebar.",
      "Click '+ New Branch' to set branch address, phone, and receipt header.",
      "Assign cash registers and tables if you operate a restaurant/cafe.",
    ],
  },
  {
    id: "add_products",
    ...
    defaultTitle: "2. Add Catalog & Products",
    descKey: "guide.step2.desc",
    defaultDesc: "Create categories and enter your products with selling prices, cost prices, and barcodes.",
    icon: Package,
    route: "/products",
    actionHintKey: "guide.step2.hint",
    defaultActionHint: "Open Products to create categories, SKUs, and items.",
    details: [
      "Go to 'Products' or 'Catalog' from the sidebar.",
      "First create Categories (e.g. Beverages, Bakery, Meals, Groceries).",
      "Click '+ New Product', fill name, selling price, cost price, and assign a category.",
      "Optionally add barcode/SKU or recipe ingredients for auto-deduction.",
    ],
  },
  {
    id: "inventory_stock",
    ...
    defaultTitle: "3. Stock & Inventory Management",
    descKey: "guide.step3.desc",
    defaultDesc: "Enter your initial quantities, receive goods from suppliers, and monitor low stock alerts.",
    icon: BarChart3,
    route: "/inventory",
    actionHintKey: "guide.step3.hint",
    defaultActionHint: "Open Inventory to adjust starting stock and track movements.",
    details: [
      "Go to 'Inventory' to see real-time stock levels across centers.",
      "Click '+ Movement / Adjustment' to enter your starting quantities.",
  ...
  },
  {
    ...
    defaultTitle: "4. Open Cash Register (Money Management)",
    descKey: "guide.step4.desc",
    defaultDesc: "Before selling, open a cash session with your initial base float.",
    icon: Wallet,
    route: "/cash",
    ...
    details: [
      ...
      "Click 'Open Cash Session' to enable sales and register cash in/out.",
    ],
  },
  {
    id: "pos_sales",
    ...
    defaultTitle: "5. Ring Up Sales & Collect Payment",
    descKey: "guide.step5.desc",
    defaultDesc: "Sell products quickly via touch POS, Table Orders, or Barcode scanner.",
    icon: ShoppingCart,
    route: "/pos",
    actionHintKey: "guide.step5.hint",
    defaultActionHint: "Go to POS to ring items, choose payment method, and complete sales.",
    details: [
      "Open 'POS' or 'Tables'. Tap items to add to cart or scan barcode.",
      "Click 'Pay' and select payment: Cash, M-Pesa / Tigo Pesa / Airtel Money, Card, or Bank transfer.",
      "Enter tendered amount to see change, and print or share digital receipt.",
    ],
  },
  {
    id: "customers_crm",
    ...
    defaultTitle: "6. Register Customers & Loyalty",
    descKey: "guide.step6.desc",
    defaultDesc: "Build customer relationships, save contact details, and award loyalty points.",
    icon: Users,
    route: "/customers",
    actionHintKey: "guide.step6.hint",
    defaultActionHint: "Open Customers to create client profiles and manage credit/points.",
    details: [
      "Go to 'Customers' and click '+ New Customer'.",
      "Enter name, phone number, email, and address.",
      "Select customer in POS cart to accumulate loyalty points with every purchase.",
    ],
  },
  {
    id: "close_cash",
    ...
    details: [
      ...
      "Check 'Reports' to view daily revenue, best sellers, and export CSV.",
    ],
  },
];
